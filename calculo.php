...
<head>
    ...
    <title>Calcu ladora off grid</title>
</head>
    ...
    <main>
        <form method="post" action="calculo.php">
            ...
            <div class="container-wrapper">
                ...
                <div class="resultado">
                    <div class="itens">
                        <div id="etapa-placa" class="etapa etapa-ativa ativa">
                            ...
                            <div class="campo">
                                <div class="placa">
                                    ...
                                    <small class="erro-mensagem">Campo obrigatório</small>
                                </div>
                            </div>
                            <div class="campo">
                                <div class="tensao">
                            ...
                            <div id="etapa-bateria" class="etapa etapa-ativa">
                                <div class="campo">
                                <div class="bateria">
